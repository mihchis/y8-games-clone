...
(function (f) {
    ...
    var define, module, exports;return function () {
        function r(e, n, t) {
            ...
            // Lấy đường dẫn cơ sở cho media
            var mediaBasePath = window.DEMOQUEST_MEDIA_BASE_PATH || "";
            
            module.exports.Effects = {
                Crow: mediaBasePath + "/media/effects/crow.mp3",
                Drip: mediaBasePath + "/media/effects/water-drop.mp3",
                ShapeSound: mediaBasePath + "/media/effects/ufo.mp3",
                ShapeSound2: mediaBasePath + "/media/effects/ufo2.mp3",
                DoorOpening: mediaBasePath + "/media/effects/door-opening.mp3",
                DoorClosing: mediaBasePath + "/media/effects/door-closing.mp3",
                Crickets: mediaBasePath + "/media/effects/crickets.mp3",
                Crickets2: mediaBasePath + "/media/effects/crickets2.mp3",
                Cupboard: mediaBasePath + "/media/effects/soft-click.mp3",
                Switch: mediaBasePath + "/media/effects/soft-click.mp3",
                Monster: mediaBasePath + "/media/effects/creepy-snake.mp3",
                Bang: mediaBasePath + "/media/effects/bang.mp3",
                Purring: mediaBasePath + "/media/effects/purring.mp3",
                PurringFast: mediaBasePath + "/media/effects/purring2.mp3"
            };
            ...
            */
                    ...
                    if (req.readyState == 4 && req.status == "200") {
                        ...
                        try {
                            for (var _iterator9 = scenes[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                                ...
                                // Sử dụng đường dẫn tuyệt đối nếu basedir là đường dẫn tương đối
                                var scenePath = basedir + scene + "/scene.json";
                                if (basedir.indexOf("/") === 0 || basedir.indexOf("http") === 0) {
                                    _this15.add(scenePath);
                                } else {
                                    var mediaBasePath = window.DEMOQUEST_MEDIA_BASE_PATH || "";
                                    _this15.add(mediaBasePath + "/" + scenePath);
                                }
                            }
                        } catch (err) {
            ...
            LoadingScreen.prototype._loadSceneData = function () {
                ...
                var mediaBasePath = window.DEMOQUEST_MEDIA_BASE_PATH || "";
var ldr = new SceneDataLoader(mediaBasePath + "/media/scenes/index.json");
            ...
            function SceneData(scenePath) {
                ...
                // Xử lý đường dẫn sprites
                var lastSlash = scenePath.lastIndexOf("/");
                var sceneDir = scenePath.substring(0, lastSlash + 1);
                this.spritesPath = sceneDir + this.spritesFile;
